  ...
  { id:1, title:'Waking', mood:'BRIGHT',
    ...
    scenes:[
      ...
      { id:'1.5', title:"The postcard", bg:'bg-peaceful-field-arc-1', mascot:'mascot-wow',
        ...
        en:'It was an old postcard. The front showed a **lantern hanging from a wooden post**, with text printed below: *THE KEEPER\'S STATION — 400 MILES.* On the back, written in **glowing blue ink** that faintly shone even in daylight, was a single line: *"If you found this, you\'re **already further than I got**."* **No signature**. Just a small, clean tear in one corner, notched out in the **shape of a bird\'s beak**. ⟦D-02⟧',
  ...
  { id:5, title:"The Well That Says No", mood:'SHOCK',
    ...
    scenes:[
      ...
      { id:'5.6', title:"Leaving the well", bg:'bg-desert-and-cactus-arc-2', mascot:'mascot-wander',
        props:['other-well'],
        en:"Focci looked back once. Vask had already settled back onto her stony perch, **unmoved and steady**, the worn ledger **tucked securely under her wing**. ⟦D-06⟧",
